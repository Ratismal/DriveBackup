        ...
        try {
            ...
            if (PlayerListener.doBackups || forced) {
                ...
                if (forced) {
                    ...
                    MessageUtil.sendMessageToAllPlayers(Config.getBackupDone() + " " + Config.getBackupNext()
                            .replaceAll("%TIME", String.valueOf(Config.getBackupDelay() / 20 / 60)));
                }
            ...
            MessageUtil.sendConsoleMessage("ERROR: Something went wrong in UploadThread:" + e.getMessage());
        }
    }
